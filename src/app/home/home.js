...
import Card3page from "../ui/card3";
...
import gb from "@/../public/cardImage/gb.webp"
import ar from "@/../public/cardImage/ar.webp"
import cn from "@/../public/cardImage/cn.webp"
import it from "@/../public/cardImage/it.webp"  
import ind from "@/../public/cardImage/in.webp"
import fr from "@/../public/cardImage/fr.webp"
import za from "@/../public/cardImage/za.webp"
import lk from "@/../public/cardImage/lk.webp"
...
const Homepage = () => {
  ...
  const scrollContainerRefNext = useRef(null);
                        ...
                        <div className="flex flex-col gap-6 items-center lg:w-[40%] w-full px-12">
                            <div className="bg-[#06b5c5] rounded-md w-full p-4 text-center text-[#ffffff] flex flex-col items-center shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] hover:shadow-none" >
                                ...
                                <div className="flex flex-wrap justify-center gap-4 ">
                                    ...
                                    <Image alt="Flag 0" loading="lazy" width="70" height="25" decoding="async" data-nimg="1" className="rounded shadow border-2 border-[#ffffff]" src={gb} />
                                    <Image alt="Flag 0" loading="lazy" width="70" height="25" decoding="async" data-nimg="1" className="rounded shadow border-2 border-[#ffffff]" src={ar} />
                                    <Image alt="Flag 0" loading="lazy" width="70" height="25" decoding="async" data-nimg="1" className="rounded shadow border-2 border-[#ffffff]" src={cn} />
                                    <Image alt="Flag 0" loading="lazy" width="70" height="25" decoding="async" data-nimg="1" className="rounded shadow border-2 border-[#ffffff]" src={it} />
                                    <Image alt="Flag 0" loading="lazy" width="70" height="25" decoding="async" data-nimg="1" className="rounded shadow border-2 border-[#ffffff]" src={ind} />
                                    <Image alt="Flag 0" loading="lazy" width="70" height="25" decoding="async" data-nimg="1" className="rounded shadow border-2 border-[#ffffff]" src={fr} />
                                    <Image alt="Flag 0" loading="lazy" width="70" height="25" decoding="async" data-nimg="1" className="rounded shadow border-2 border-[#ffffff]" src={za} />
                                    <Image alt="Flag 0" loading="lazy" width="70" height="25" decoding="async" data-nimg="1" className="rounded shadow border-2 border-[#ffffff]" src={lk} />
                                </div>

                            </div>

                            <div className="bg-[#981d26] w-full  rounded-md p-4 text-center text-[#ffffff] shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] hover:shadow-none">
